...
# Email admin pour les notifications (OBLIGATOIRE pour recevoir les alertes)
ADMIN_EMAIL = os.environ.get('ADMIN_EMAIL', 'papidiop055@gmail.com')  # Défaut si non défini
